...
public class ToDoService {
	...
	public ToDoResponse upsert(ToDoSaveRequest toDoDTO, Boolean isAdmin) throws ToDoNotFoundException, NoPermissionException {
		if (!isAdmin) throw new NoPermissionException("Only admin can do this");
		ToDoEntity todo;
	...
	public ToDoResponse completeToDo(Long id, Boolean isAdmin) throws ToDoNotFoundException, NoPermissionException {
		if (!isAdmin) throw new NoPermissionException("Only admin can do this");
	...
	public void deleteOne(Long id, Boolean isAdmin) throws NoPermissionException {
		if (!isAdmin) throw new NoPermissionException("Only admin can do this");
